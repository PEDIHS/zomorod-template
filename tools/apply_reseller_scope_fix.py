...
if 'def _has_profile_overrides(' not in text:
...
if 'async def scoped_standard_subscription(' not in text:
    text = text.rstrip() + standard_routes + '\n'
